                                 ...
                                 const integer  dimmx)
{
    ...
    #pragma omp parallel for label(compute_vcell_tr)
    for(integer y=ny0; y < nyf; y++)
    {
        for(integer x=nx0; x < nxf; x++)
        {
                                 ...
                                 const integer         dimmx)
{
    ...
    #pragma omp parallel for label(compute_vcell_br)
    for(integer y=ny0; y < nyf; y++)
    {
        for(integer x=nx0; x < nxf; x++)
        {
                                 ...
                                 const integer  dimmx)
{
    ...
    #pragma omp parallel for label(compute_vcell_bl)
    for(integer y=ny0; y < nyf; y++)
    {
        for(integer x=nx0; x < nxf; x++)
        {
...
#pragma omp task label(velocity_propagator)
    {
...
#pragma omp task label(stress propagator)
    {
                                 ...
                                 const integer  dimmx)
{
    ...
    #pragma omp parallel for label(compute_scell_tl)
    for (integer y = ny0; y < nyf; y++)
    {
        for (integer x = nx0; x < nxf; x++)
        {
                                 ...
                                 const integer  dimmx)
{
    ...
    #pragma omp parallel for label(compute_scell_br)
    for (integer y = ny0; y < nyf; y++)
    {
        for (integer x = nx0; x < nxf; x++)
        {
                                 ...
                                 const integer  dimmx)
{
    ...
    #pragma omp parallel for label(compute_scell_bl)
    for (integer y = ny0; y < nyf; y++)
    {
        for (integer x = nx0; x < nxf; x++)
        {
